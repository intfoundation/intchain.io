    ...
    pages: {
      home: {
        ...
        gridIcons: {
          ...
          header3: `Advanced decentralized P2P protocol`,
          desc3: `INT utilises an innovative BDT protocol that makes mainnet operation more adaptable to node mobility and heterogeneous requirements of new IoT application scenarios.`,
          ...
          header5: `Custom smart contract development`,
          desc5: `Tailored smart contracts and cross-chain protocol technology in a public chain environment to achieve broader application development for different devices. Lower threshold of BoT application development and more flexible real-world use cases.`,
        ...
        tendermintSubTitle: `INT harnesses the Tendermint PBFT (practical byzantine fault tolerant) engine to power the network's consensus protocol.`,
      ...
      nodeplan: {
        ...
        panelsDesc2: [`100 Validator Nodes`, `Candidate Nodes`, `4000 TPS`],
      ...
      wallet: {
        ...
        iosWalletTitle: `Smart Wallet for iOS`,
        ...
        smartWalletTitle: `Smart Wallet for Android`,
    ...
    pages: {
      home: {
        ...
        gridIcons: {
          ...
          header3: `先进的无中心化P2P协议`,
          desc3: `INT利用创新的BDT协议，使主网运行更加适应节点移动性和物联网新应用场景的异构要求。`,
          header4: `有效的通证经济激励`,
          desc4: `采用有效的通证经济和激励措施，以推动网络治理，社区活动以及物联网数据和设备管理。`,
          header5: `预见性的智能合同研发`,
          desc5: `成功研发的智能合同及跨链协议技术，实现不同设备的公链接入和应用开发，拉低区块链物联网应用开发门槛，切实推动场景应用开发的落地运行。`,
          header6: `真实的应用落地演进`,
        ...
        viewMoreNews: `查看最新消息`,
        tendermintTitle: `Tendermint`,
        tendermintSubTitle: `INT采用Tendermint PBFT（实用的拜占庭容错）引擎来驱动网络的共识协议。`,
        partners: `合作伙伴`,
      ...
      nodeplan: {
        ...
        panelsDesc2: [`100个验证节点`, `候选节点`, `4000 TPS`],
      ...
      wallet: {
        ...
        webWalletLink: `访问Web钱包`,
        iosWalletTitle: `iOS Smart Wallet`,
        iosWalletDesc: ` 包括Web钱包的所有功能以及INT抵押服务。干净、简单、安全。`,
        iosWalletLink: `下载Smart Wallet`,
        smartWalletTitle: `Android Smart Wallet`,
