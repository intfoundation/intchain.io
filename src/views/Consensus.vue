                ...
                <div class="consensus__row">
                    <div class="consensus__menu">
                        <nav class="pagenav" :class="{'fixed':isFixed}">
                            <a :class="{'active': navIndex===0}" @click="onClickNav(0)">{{ $t('pages.consensus.q1T') }}</a>
                            <a :class="{'active': navIndex===1}" @click="onClickNav(1)">{{ $t('pages.consensus.q2T') }}</a>
                            <a :class="{'active': navIndex===2}" @click="onClickNav(2)">{{ $t('pages.consensus.q3T') }}</a>
                            <a :class="{'active': navIndex===3}" @click="onClickNav(3)">{{ $t('pages.consensus.q4T') }}</a>
                        </nav>
                    </div>
                    <div class="consensus__content">
                        <div id="id1" ref="content1" class="consensus__content-item">
                            <div class="consensus__content-title">{{ $t('pages.consensus.q1T') }}</div>
                            <div
                        ...
                        <div id="id2" ref="content2" class="consensus__content-item">
                            <div class="consensus__content-title">{{ $t('pages.consensus.q2T') }}</div>
                            <div
                                class="consensus__content-p"
                        ...
                        <div id="id3" ref="content3" class="consensus__content-item">
                            <div class="consensus__content-title">{{ $t('pages.consensus.q3T') }}</div>
                            <div
                                class="consensus__content-p"
                        ...
                        <div id="id4" ref="content4" class="consensus__content-item">
                            <div class="consensus__content-title">{{ $t('pages.consensus.q4T') }}</div>
                            <div
                                class="consensus__content-p"
