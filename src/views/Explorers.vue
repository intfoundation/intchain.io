  ...
  <div class="view-container">
        <div class="section section--light">
          <div class="section__content section__content--hr-top content-container">
            ...
            <div class="explorers">
              <h3>INT Chain 3.0</h3>
              <div class="explorers_item">
                <a class="explorer" href="https://explorer.intchain.io" target="_blank">
              ...
              <h3>INT Chain 4.0</h3>
              <div class="explorers_item">
                <a class="explorer" href="https://titansexplorer.intchain.io" target="_blank">
                  <div class="explorer__logo">
                    <img src="../assets/images/explorers/int.png" alt="" width="100" />
                    <span>Mainnet</span>
                  </div>
                </a>
                <a class="explorer" href="https://test.titansexplorer.intchain.io" target="_blank">
                  <div class="explorer__logo">
                    <img src="../assets/images/explorers/int.png" alt="" width="100" />
                    <span>Testnet</span>
                  </div>
