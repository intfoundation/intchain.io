      ...
      (d = fb.selectors = {
        ...
        pseudos: {
          ...
          lt: nb(function(a, b, c) {
            for (let d = 0 > c ? c + b : c; --d >= 0; ) a.push(d);
            return a;
          }),
          gt: nb(function(a, b, c) {
            for (let d = 0 > c ? c + b : c; ++d < b; ) a.push(d);
            return a;
          })
        }
      }),
  ...
  (m.offset = {
    ...
    m.each({ Height: "height", Width: "width" }, function(a, b) {
      m.each({ padding: "inner" + a, content: b, "": "outer" + a }, function(
        ...
        m.fn[d] = function(d, e) {
          const f = arguments.length && (c || "boolean" != typeof d),
